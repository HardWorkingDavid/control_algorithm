...
if("TRUE" STREQUAL "TRUE")
  set(MPC_SOURCE_PREFIX /home/bigdavid/视频/Control_algorithm/src/MPC)
  set(MPC_DEVEL_PREFIX /home/bigdavid/视频/Control_algorithm/devel)
  set(MPC_INSTALL_PREFIX "")
  set(MPC_PREFIX ${MPC_DEVEL_PREFIX})
else()
  set(MPC_SOURCE_PREFIX "")
  set(MPC_DEVEL_PREFIX "")
  set(MPC_INSTALL_PREFIX /home/bigdavid/视频/Control_algorithm/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'MPC' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bigdavid/视频/Control_algorithm/src/MPC/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT MPC_NUM_DUMMY_TARGETS)
      set(MPC_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::MPC::wrapped-linker-option${MPC_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR MPC_NUM_DUMMY_TARGETS "${MPC_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::MPC::wrapped-linker-option${MPC_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND MPC_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(MPC_EXPORTED_TARGETS ${${MPC_dep}_EXPORTED_TARGETS})
endforeach()
