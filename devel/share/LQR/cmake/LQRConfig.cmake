...
if("TRUE" STREQUAL "TRUE")
  set(LQR_SOURCE_PREFIX /home/bigdavid/视频/Control_algorithm/src/LQR)
  set(LQR_DEVEL_PREFIX /home/bigdavid/视频/Control_algorithm/devel)
  set(LQR_INSTALL_PREFIX "")
  set(LQR_PREFIX ${LQR_DEVEL_PREFIX})
else()
  set(LQR_SOURCE_PREFIX "")
  set(LQR_DEVEL_PREFIX "")
  set(LQR_INSTALL_PREFIX /home/bigdavid/视频/Control_algorithm/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'LQR' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bigdavid/视频/Control_algorithm/src/LQR/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT LQR_NUM_DUMMY_TARGETS)
      set(LQR_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::LQR::wrapped-linker-option${LQR_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR LQR_NUM_DUMMY_TARGETS "${LQR_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::LQR::wrapped-linker-option${LQR_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND LQR_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(LQR_EXPORTED_TARGETS ${${LQR_dep}_EXPORTED_TARGETS})
endforeach()
